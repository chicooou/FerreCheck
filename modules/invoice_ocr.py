...
def extract_invoice_data(image_bytes: bytes, mime_type: str) -> Dict[str, Any]:
    ...
    system_instruction = (
        ...
        "INSTRUCCIONES:\n"
        "1. Analiza la imagen y extrae el número de factura, la fecha de emisión de la factura, el total de la factura y todas las líneas de productos o insumos.\n"
        "2. El campo 'total' de la factura debe ser el monto total facturado.\n"
        ...
        "4. CUIDADO CON LOS DECIMALES Y SEPARADORES: Los números en facturas de Guatemala a veces usan ',' o '.' para decimales y miles. "
        "Asegúrate de interpretar correctamente los decimales. Por ejemplo, '1,875.58' o '1.875,58' debe ser parseado como el número float 1875.58. "
        "Bajo ninguna circunstancia omitas el punto decimal (ej: nunca conviertas '1,875.58' a '187558.00').\n"
        "5. Devuelve ÚNICAMENTE un objeto JSON bien formado sin rodeos, explicaciones ni etiquetas markdown "
